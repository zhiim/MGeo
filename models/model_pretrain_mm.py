...
from models.xbert import BertConfig, BertModel, BertOnlyMLMHead
...
class MGeo(nn.Module):
    ...
    def text_forward(self, text, gis):
        ...
        loss = loss_fct(
            txt_score.view(-1, self.text_vocab_size), labels.view(-1)
        )
        return loss
    ...
    def tg_forward(self, text, gis):
        ...
        loss = loss_fct(
            ...
            gis_score.view(-1, self.gis_vocab_size), gis_labels.view(-1)
        )
